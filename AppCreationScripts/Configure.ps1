...
#> 
   ...
   $dictionary = @{ "Application_Id" = $serviceAadApplication.AppId;"Tenant_Id" = $tenantId;"Client_Secret" = $serviceAppKey };
   ReplaceInTextFile -configFilePath $configFile -dictionary $dictionary

   # Update config file for 'client'
   $configFile = $pwd.Path + "\..\SPA\src\authConfig.js"
   Write-Host "Updating the sample code ($configFile)"
   $dictionary = @{ "Application_Id" = $clientAadApplication.AppId;"Tenant_Id" = $tenantId;"Web_Api_Scope" = ("api://"+$serviceAadApplication.AppId+"/access_as_user") };
   ReplaceInTextFile -configFilePath $configFile -dictionary $dictionary
